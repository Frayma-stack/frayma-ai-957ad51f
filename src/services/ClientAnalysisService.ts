...
export class ClientAnalysisService {
  static async analyzeCompany(
    ...
    console.log("Starting client analysis with pre-fetching...", {
      companyLinks,
      companyName,
    });
    ...
    const { systemPrompt, userPrompt } = buildClientAnalysisPrompt(
      validLinks,
      companyName
    );
    ...
    console.log(
      "Sending analysis request with pre-fetched content approach..."
    );
