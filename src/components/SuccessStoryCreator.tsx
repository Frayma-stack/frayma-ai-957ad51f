            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 opacity-70">Product-Led Storytelling with AI-powered crafting</p>
                </div>
              </div>
              
              <div className="mb-4">
                <p className="text-sm text-gray-700 mb-3 opacity-80">
                ...
                <div className="bg-white/70 rounded-lg p-3 mb-4">
                  ...
                  <ul className="text-xs text-gray-600 space-y-1 opacity-75">
