...
interface AuthorBeliefsSectionProps {
...
const AuthorBeliefsSection: FC<AuthorBeliefsSectionProps> = ({
  beliefs,
  onBeliefChange,
  onAddBelief,
  onRemoveBelief
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="font-medium text-story-blue">Product Beliefs & Takes</h3>
        <Button 
          variant="outline" 
          size="sm" 
          onClick={onAddBelief}
...
export default AuthorBeliefsSection;
