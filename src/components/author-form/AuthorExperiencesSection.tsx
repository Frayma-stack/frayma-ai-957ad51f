...
interface AuthorExperiencesSectionProps {
...
const AuthorExperiencesSection: FC<AuthorExperiencesSectionProps> = ({
  experiences,
  onExperienceChange,
  onAddExperience,
  onRemoveExperience
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="font-medium text-story-blue">Professional Experiences</h3>
        <Button 
          variant="outline" 
          size="sm" 
...
export default AuthorExperiencesSection;
